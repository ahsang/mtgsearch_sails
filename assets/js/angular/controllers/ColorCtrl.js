app.controller('ColorCtrl', ['$scope', '$http', '$location', 'ngTableParams', 'ngTableFactory', 'alertFactory', function ($scope, $http, $location, ngTableParams, ngTableFactory, alertFactory) {
    var single = 'color';
