app.controller('TypeCtrl', ['$scope', '$http', '$location', 'ngTableParams', 'ngTableFactory', 'alertFactory', function ($scope, $http, $location, ngTableParams, ngTableFactory, alertFactory) {
    var single = 'type';
